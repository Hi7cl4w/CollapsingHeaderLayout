...
public let CollapsingHeaderLayoutParallax = "CollapsingHeaderLayoutParallax"

open class CollapsingHeaderLayout: UICollectionViewFlowLayout {
  ...
  open override func layoutAttributesForSupplementaryView(ofKind elementKind: String, at indexPath: IndexPath) -> UICollectionViewLayoutAttributes? {
    ...
    if attributes != nil && elementKind == CollapsingHeaderLayoutParallax {
      attributes = CollapsingHeaderLayoutAttributes(forSupplementaryViewOfKind: elementKind, with: indexPath)
    }
  ...
  open override func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
    ...
    if visibleParallaxHeader && !CGSize.zero.equalTo(self.parallaxHeaderReferenceSize!) {
      let currentAttribute = CollapsingHeaderLayoutAttributes(forSupplementaryViewOfKind: CollapsingHeaderLayoutParallax, with: IndexPath(index:0))
